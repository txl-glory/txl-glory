...
set RUNJAR=%CATALINA_BASE%\bin\bootstrap.jar
...
@echo on
"%JAVA_HOME%\bin\java" %JAVA_OPTS% -DEXTERNAL_CONFIG_DIR="%EXTERNAL_CONFIG_DIR%" -Djava.net.preferIPv4Stack=true -Djava.endorsed.dirs="%CATALINA_BASE%\common\endorsed" -classpath "%CATALINA_CLASSPATH%" -Dcatalina.base="%CATALINA_BASE%" -Dcatalina.home="%CATALINA_BASE%" -Djava.io.tmpdir="%CATALINA_BASE%\temp" org.apache.catalina.startup.Bootstrap  start
