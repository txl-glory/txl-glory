...
JBOSS_BOOT_CLASSPATH="$JBOSS_BOOT_CLASSPATH:$JBOSS_HOME/server/default/lib/bcprov-jdk15-1.41.0.jar"
...
if [ "x$1" = "x-debug" ]; then
	JAVA_OPTS="-Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=8787 $JAVA_OPTS"
fi

JAVA_OPTS="$JAVA_OPTS -Djboss.bind.address=0.0.0.0 -Djavax.xml.soap.SAAJMetaFactory=com.sun.xml.messaging.saaj.soap.SAAJMetaFactoryImpl -DEXTERNAL_CONFIG_DIR=$EXTERNAL_CONFIG_DIR -Djava.net.preferIPv4Stack=true"
