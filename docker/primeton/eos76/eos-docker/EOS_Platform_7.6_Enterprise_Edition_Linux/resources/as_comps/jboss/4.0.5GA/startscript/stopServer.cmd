...
rem $Id: stopServer.cmd,v 1.1 2008/07/04 13:40:35 build Exp $
...
if "%OS%" == "Windows_NT" set DIRNAME=${RP_JBOSS_HOME}/bin
...
"%JAVA%" %JAVA_OPTS% -classpath "%JBOSS_CLASSPATH%" %MAIN_CLASS% -S
